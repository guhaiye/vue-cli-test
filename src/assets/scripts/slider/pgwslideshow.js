 ...
 */
 import userPhoto from '@/assets/img/imgerror.png'
...
(function($, window, document){
    $.fn.pgwSlideshow = function(options) {
        ...
        var setup = function() {
            ...
            // Create container
            $(".ps-current,.ps-prev,.ps-next").remove();
            var _lent = $(".ps-list").length;
            if(_lent == 0){
            ...
            pgwSlideshow.plugin.prepend('<div class="ps-current"><ul id="pscurrentid"></ul><span class="ps-caption"></span></div>');
            ...
            pgwSlideshow.plugin.find('.ps-list > ul > li').each(function() {
                ...
                var _len = $(this).children('span').length;
                if(_len == 0){
                ...
                if (element.image) {
                    currentElement.html('<img onerror=javascript:this.src="'+userPhoto+'" src="' + element.image + '" alt="' + (element.title ? element.title : '') + '">');
                } else if (element.thumbnail) {
                    currentElement.html('<img onerror=javascript:this.src="'+userPhoto+'" src="' + element.thumbnail + '" alt="' + (element.title ? element.title : '') + '">');
                }

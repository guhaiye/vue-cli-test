    ...
    <div class="app-content">
      ...
      <div class="appcontent">
        <div class="appcontent-con">
          <breadCrumb  v-if="['/views/scan'].indexOf($route.path) < 0" :newbar="newbar" />
...
export default {
    computed: mapState({
        ...
        isloadnode: state => state.isloadnode,
        codeParams: state => state.setCodeParams.codeParams
    }),
        ...
        buildMenuTree(firstMenus, leftMenus) {
            ...
            for (var i in firstMenus) {
                for (var j in leftMenus) {
                    if (
                        firstMenus[i].ishidden === false &&
                        leftMenus[j].ishidden === false &&
                        firstMenus[i].nodetype !== 2 &&
                        leftMenus[j].nodetype !== 2
                    ) {
